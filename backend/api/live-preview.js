...
// Initialize WebContainer with fallback
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Try to use WebContainer, but provide fallback if not available
    try {
...
<body>
    ...
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
      ...
      // Fallback: return analysis only without live preview
      res.status(200).json({ 
        success: true,
        url: null,
        previewHTML: null,
        ...
        dependencies: analysis?.imports || [],
        timestamp: new Date().toISOString(),
        message: 'Live preview not available in this environment, but component analysis is provided.'
      });
    }
